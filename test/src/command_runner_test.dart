...
import 'package:lego/src/command_runner.dart';
...
void main() {
  group('LegoCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late LegoCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = LegoCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = LegoCommandRunner();
